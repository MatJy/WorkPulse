    ...
    <main className='min-h-screen bg-gradient-to-br from-sky-100 to-blue-200 flex items-center justify-center px-4'>
      <div className='w-full max-w-md bg-white rounded-xl shadow-md p-6 space-y-6'>
        ...
        <form className='space-y-4' action={signup}>
          ...
          <button
            type='submit'
            className='cursor-pointer w-full bg-gradient-to-r from-indigo-500 to-blue-500 text-white font-semibold py-2 px-4 rounded-md hover:opacity-90 transition'
          >
            Sign up
          </button>
        </form>
